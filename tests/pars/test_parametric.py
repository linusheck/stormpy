...
class TestParametric:
    ...
    def test_parametric_model_checking_dd(self):
        ...
        assert type(result) is stormpy.SymbolicQuantitativeCheckResult[stormpy.RationalFunction]
    ...
    def test_parametric_model_checking_hybrid(self):
        ...
        assert type(result) is stormpy.HybridQuantitativeCheckResult[stormpy.RationalFunction]
